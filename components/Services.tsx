...
const services = [
  ...
  {
    title: 'Skylights',
    description: 'Natural light enhancements',
    image: '/placeholder.svg',
  },
  {
  ...
  {
    title: 'Chimney Work',
    description: 'Full chimney services',
    image: '/placeholder.svg',
  },
];
...
export function Services() {
  return (
    <section id="services" className="py-24 bg-light-bg diagonal-pattern relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="font-barlow text-sm text-accent tracking-widest uppercase">OUR SERVICES</span>
          ...
          <p className="font-body text-text/70 max-w-2xl">
            From installation to maintenance, we deliver precision across every roofing service.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-end p-6">
                <h3 className="font-display text-xl font-900 text-bg uppercase tracking-wide mb-2">{service.title}</h3>
