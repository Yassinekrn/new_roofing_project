...
const materials = [
    ...
    { name: "Steel Framing", category: "Structural Steel", color: "#A08638" },
    {
        name: "Premium Drywall",
        category: "Interior Materials",
        color: "#6B5436",
    },
    {
        name: "Eco-Friendly Lumber",
        category: "Sustainable Materials",
        color: "#4A3A25",
    },
    { name: "Ceramic Tile", category: "Flooring", color: "#7A7A7A" },
    { name: "Premium Paint", category: "Finishes", color: "#B8956A" },
    { name: "Stone & Granite", category: "Countertops", color: "#3A3A38" },
    {
        name: "Vinyl & Laminate",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="font-body text-text/70 max-w-2xl">
                        We exclusively use industry-leading materials from
                        ...
                        >
                            ...
                            <div className="relative h-full flex flex-col justify-center items-center p-4 text-center">
                                <motion.div
                                    ...
                                    className="space-y-2"
                                >
                                    <h3 className="font-barlow text-sm font-600 text-heading tracking-wide uppercase">
                                        {material.name}
                                    </h3>
