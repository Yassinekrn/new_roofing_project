            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        <Link
                            href="/"
                            className="font-bebas text-2xl text-primary tracking-wider block"
                        >
                            PINNACLE
                        </Link>
                        <p className="font-dm text-foreground/70 text-sm leading-relaxed">
                            Premium construction solutions for 20+ years.
                            Creating architectural statements that protect your
                            legacy.
                        </p>
                        {/* Social Links */}
                    ...
                    {footerLinks.map((column) => (
                        <div key={column.title}>
                            <h3 className="font-bebas text-foreground mb-4 tracking-wide">
                                {column.title}
                            </h3>
                ...
                >
                    <p className="font-dm text-sm text-foreground/60 text-center md:text-left">
                        © 2026 Pinnacle Construction Co. All rights reserved.
                    </p>
                    ...
                    <div className="flex gap-6">
                        <Link
                            href="#"
                            className="font-dm text-sm text-foreground/60 hover:text-primary transition-colors duration-300"
                        >
                            Privacy Policy
                        </Link>
                        <Link
